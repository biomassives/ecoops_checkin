...
<div className="disciplines">
            <p>Resources:</p>
            <a href='/biodiversity'><button>Biodiversity</button></a>
            <a href='/planet_regen'><button>Plant Regeneration</button></a>
            <a href='/soildev'><button>Soil Development</button></a>
            <a href='/compostmanure'><button>Compost Manure</button></a>
            <a href='/wildplaces'><button>Wild Places</button></a>
            <a href='/site_remediation'><button>Site Remediation</button></a>
            <a href='/rivers'><button>Rivers</button></a>
            <a href='/coastal'><button>Coastal</button></a>
            
            <a href='/wasterq'><button>Water Quality</button></a>
            <a href='/pumps'><button>Pumps</button></a>
            <a href='/windmills'><button>Windmills</button></a>
            <a href='/solar'><button>Solar</button></a>
            <a href='/electrical'><button>Elec</button></a>
            <a href='/plumbing'><button>Plumbing</button></a>
            <a href='/carpentry'><button>Carpentry</button></a>
            <a href='/IT'><button>IT</button></a>
            <a href='/filtration'><button>Water & Air Filter</button></a>
            <a href='/stoves'><button>Cook Stoves</button></a>
            <a href='/circular'><button>Circular Economies</button></a>
          </div>
